System.register(["@angular/http", "@angular/core", "rxjs/Observable", "../lib/monomer_db", "rxjs/Rx", "../services/monomerloader", "../lib/application_control_manager", "../services/urls"], function (exports_1, context_1) {
    ...
    var http_1, core_1, Observable_1, monomer_db_1, monomerloader_1, application_control_manager_1, urls_1, NewMonomer;
    return {
        setters: [
            function (http_1_1) {
                http_1 = http_1_1;
        ...
        execute: function () {
            NewMonomer = (function () {
                function NewMonomer(monomer_loader, ref, http) {
                ...
                NewMonomer.prototype.updateSelectedStructure = function (ionisMon, msg) {
                };
                NewMonomer.prototype.updateSelectedSubstructureList = function (substructureList) {
                    //this.monomers = this.listWithSubstructureFilter(substructureList);
                    this.ref.markForCheck();
                };
                NewMonomer.prototype.ngOnInit = function () {
                ...
                NewMonomer.prototype.validateCurrentStructure = function () {
                    var _this = this;
                ...
                NewMonomer.prototype.setResults = function (results) {
                    this.search_status = '';
                    if (results) {
                ...
                NewMonomer.prototype.handleError = function (error) {
                    this.search_status = error.toString();
                    console.error(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                NewMonomer.prototype.loadstructure = function (input) {
                    var _this = this;
                ...
                NewMonomer.prototype.list = function () {
                    var ion = new Array();
                    var index = 0;
                ...
                NewMonomer.prototype.listWithSubstructureFilter = function (sub) {
                    var ion = new Array();
                    var index = 0;
                    if (sub != undefined && sub.length > 0) {
                        for (var propName in this.monomer_db) {
                ...
                NewMonomer.prototype.getids = function (m, type) {
                    var vals = new Array();
                    var idstr;
                    if (type == 'Endcaps') {
                        if (!m.endcapID) {
            ...
            exports_1("NewMonomer", NewMonomer);
        }
    };
});
//# sourceMappingURL=newmonomer.component.js.map